...
const Home = () => {
  ...
  return (
    <div className="flex flex-row min-h-screen w-full">
      <header className="w-1/5 flex flex-col justify-between bg-gray-50 border-r-2 p-4 border-gray-100">
        <div className="flex flex-col gap-4 justify-between">
          <div className="flex gap-1 hover:bg-gray-200 rounded-lg py-2 px-4 hover:cursor-pointer items-center text-gray-500">
            <svg
          ...
          <div className="flex gap-1 hover:bg-gray-200 rounded-lg py-2 px-4 hover:cursor-pointer text-gray-500">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="currentColor"
        ...
        <div>
          <Link
            className="flex gap-1 hover:bg-gray-200 rounded-lg py-2 px-4 hover:cursor-pointer text-red-500"
            to="/help"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        {loading ? (
          ...
          <div className="flex overflow-x-auto space-x-8">
            {courses.map((course) => (
              <div
                key={course.idCurso}
                className="flex-none flex bg-white rounded-lg shadow-md overflow-hidden cursor-pointer w-1/2 m-1 p-4"
